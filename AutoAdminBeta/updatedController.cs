...
namespace eLF_AutoAdmin
{
    public class updatedController : IHoldfastSharedMethods
    {
        ...
        public void OnIsServer(bool server)
        {
            ...
            ConsoleController.broadcast_prefix("AutoAdmin Loaded", AutoAdmin.f1MenuInputField);
        }
        ...
        {
            ArtilleryChecker.OnInteractableObjectInteraction(playerId, interactableObjectId, interactableObject, interactionActivationType, nextActivationStateTransitionIndex);
        }
